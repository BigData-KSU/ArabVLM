...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/media/pc/e/2025/Video-LLaVA/checkpoints/PathVQA/llava-7b-llama3-Path-Dataset-NEW-Instruction-lora")
    ...
    parser.add_argument("--answers-file", type=str,default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/PathVQA/PathVQA_Predictions_Model_videollava_ROCO_BLIP-04June-Context.json")
...
with open('/media/pc/d/2025/BigData/Med_MEGA/finetune_images/medvqa/Train_MedVQA_One_Instruction.json', 'r') as file:
    data = json.load(file)

# Filter the data to keep only "Describe the image" questions
filtered_data = []
for item in data:
    for conversation in item['conversations']:
        if conversation['from'] == 'human' and "Describe the image" in conversation['value']:
            filtered_data.append(item)
            break

# Save the filtered data to a new JSON file
with open('/media/pc/d/2025/BigData/Med_MEGA/finetune_images/medvqa/Train_MedVQA_Summary_Only.json', 'w') as file:
