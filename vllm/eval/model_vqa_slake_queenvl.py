...
def eval_model(args):
    ...
    #### Supervised...
    print('Laad supervised model...................')
    model = AutoPeftModelForCausalLM.from_pretrained(
        '/media/pc/d/2025/BigData/Med_MEGA/finetune_images/slake/output_qwen',  # path to the output directory
        device_map="auto",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--answers-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/slake/TestSlake_Predictions_Model_QueenVL_ZeroShot.json")
