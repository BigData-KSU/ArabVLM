...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str,default="/media/pc/e/2025/Video-LLaVA/checkpoints/all_dataset/llava-7b-llama3-Slake-vqa-lora-10Epochs-06Aug")
    ...
    parser.add_argument("--answers-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/slake/TestSlake_Predictions_Model_videollava_06Aug.json")
