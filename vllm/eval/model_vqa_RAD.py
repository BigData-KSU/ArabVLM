...
def eval_model(args):
    ...
    for iter1 in range(len(dataset_1)):
        ...
        #### pathVQA
        image_file = '/media/pc/d/2025/BigData/Med_MEGA/finetune_images/medvqa/images/' + dataset_1[iter1]['image']+'.jpg'
...
#    parser.add_argument("--model-path", type=str, default="/media/pc/e/2025/Video-LLaVA/checkpoints/PathVQA/videollava-8b-lora-llama3-llava-Mix_shunk123456789-PMCFinal_Epoch1")
    ...
    parser.add_argument("--answers-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/medvqa/MedVQA_Predictions_Model_videollava_ROCO_BLIP-04June.json")
