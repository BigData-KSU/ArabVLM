...
def eval_model(args):
    ...
    for iter1 in range(len(dataset_1)):
        ...
        ### Salke
        video_file = '/media/pc/d/2025/BigData/Med_MEGA/finetune_images/medvqa/videos/' + dataset_1[iter1]['image'].split('.')[0]+'.mp4'
        ...
        print('*********************************************************')
        print('Image Analysis',video_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--answers-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/medvqa/TestMedVQA_Predictions_Model_videollava_ROCO_BLIP-01Aug-ZeroShot-video.json")
