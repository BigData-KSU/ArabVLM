...
def eval_model(args):
    ...
    dataset_1=dataset_1['MedVQA2019']
    ...
    for iter1 in range(len(dataset_1)):
        ...
        #### pathVQA
        image_file = '/media/pc/d/2025/BigData/Med_MEGA/finetune_images/VQA2019/Val_images/' + dataset_1[iter1]['image']+'.jpg'
...
#    parser.add_argument("--model-path", type=str, default="/media/pc/e/2025/Video-LLaVA/checkpoints/Vmed2019/llava-7b-llama3-VMed2019-Dataset-NEW-Instruction-lora")
    ...
    #### Slake
    parser.add_argument("--question-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/VQA2019/Val_MedVQA2019_summary_Final.json")
    parser.add_argument("--answers-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/VQA2019/Vmed2019_Predictions_Model_videollava_ROCO_BLIP-04June-ZeroShot.json")
