...
### My main model....
model_path = '/media/pc/e/2025/Video-LLaVA/checkpoints/videollava-8b-lora-llama3-llava-Mix_shunk123456789-PMCFinal_Epoch1'
#model_path='./checkpoints/videollava-8b-lora-llama3-roco-60k_inline_mention-01-Aug-Epoch1'
#model_path = '/media/pc/e/2025/Video-LLaVA/checkpoints/llava-7b-llama3-PATHVQA-Instruction-lora'
...
def add_file(chat_history, file):
    ...
    image_mem = Image.open(file.name).convert('RGB')
    return chat_history
...
def chat_with_gpt(text, chat_history):
    ...
    # print(outputs)
    response = outputs.replace("<|end_of_text|>", "")
...
title = "Vision-BioLLM"
description = ("Interact with the Vision-BioLLM by uploading a medical image and asking questions. "
               "Vision-BioLLM will respond based on the image and your query.")
