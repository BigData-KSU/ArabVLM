...
def eval_model(args):
    ...
    for iter1 in range(len(dataset_1)):
        ...
        for iter2 in range(len(dataset_1[iter1]['questions'])+1):
            ...
            cur_prompt='Give very short answers the questions.For questions requring answers yes or no, just provide the answer yes or no. '
...
#    parser.add_argument("--model-path", type=str, default="/media/pc/e/2025/Video-LLaVA/checkpoints/PathVQA/videollava-8b-lora-llama3-llava-Mix_shunk123456789-PMCFinal_Epoch1")
    ...
    parser.add_argument("--answers-file", type=str, default="/media/pc/d/2025/BigData/Med_MEGA/finetune_images/PathVQA/PathVQA_Predictions_Model_videollava_ROCO_BLIP-04June-ZeroShot.json")
